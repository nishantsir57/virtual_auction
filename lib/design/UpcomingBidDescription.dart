...
class UpcomingDescriptionBid extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return UpcomingDescriptionOfBid();
      },
    );
...
class UpcomingDescriptionOfBid extends StatefulWidget{
  @override
  UpcomingDescriptionOfBidState createState()=> UpcomingDescriptionOfBidState();
}

class UpcomingDescriptionOfBidState extends State<UpcomingDescriptionOfBid> {
    ...
    child: Padding(
      ...
      child: ListView(
        children: <Widget>[
          ...
          Text('This Bid is not active yet')
        ],
      ),
    ),
  );
